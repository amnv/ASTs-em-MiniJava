...
public class amnv_jrmParser extends Parser {
	...
	@Override
	public String getGrammarFileName() { return "amnv_jrm.g4"; }
	...
	public amnv_jrmParser(TokenStream input) {
		super(input);
	...
	public static class GoalContext extends ParserRuleContext {
		...
		public TerminalNode EOF() { return getToken(amnv_jrmParser.EOF, 0); }
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof amnv_jrmListener ) ((amnv_jrmListener)listener).enterGoal(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof amnv_jrmListener ) ((amnv_jrmListener)listener).exitGoal(this);
		}
	}
	...
	public static class MainClassContext extends ParserRuleContext {
		...
		public TerminalNode IDENTIFIER(int i) {
			return getToken(amnv_jrmParser.IDENTIFIER, i);
		}
		public List<TerminalNode> IDENTIFIER() { return getTokens(amnv_jrmParser.IDENTIFIER); }
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof amnv_jrmListener ) ((amnv_jrmListener)listener).enterMainClass(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof amnv_jrmListener ) ((amnv_jrmListener)listener).exitMainClass(this);
		}
	}
	...
	public final MainClassContext mainClass() throws RecognitionException {
		...
		try {
			...
			setState(27); match(T__18);
			setState(28); match(T__28);
			setState(29); match(T__12);
			setState(30); match(T__19);
			setState(31); match(T__21);
			setState(32); match(T__24);
	...
	public static class ClassDeclarationContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof amnv_jrmListener ) ((amnv_jrmListener)listener).enterClassDeclaration(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof amnv_jrmListener ) ((amnv_jrmListener)listener).exitClassDeclaration(this);
		}
	}
	...
	public final ClassDeclarationContext classDeclaration() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__22) | (1L << T__15) | (1L << IDENTIFIER))) != 0)) {
				{
				{
	...
	public static class VarDeclarationContext extends ParserRuleContext {
		public TerminalNode IDENTIFIER() { return getToken(amnv_jrmParser.IDENTIFIER, 0); }
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof amnv_jrmListener ) ((amnv_jrmListener)listener).enterVarDeclaration(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof amnv_jrmListener ) ((amnv_jrmListener)listener).exitVarDeclaration(this);
		}
	}
	...
	public static class MethodDeclarationContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof amnv_jrmListener ) ((amnv_jrmListener)listener).enterMethodDeclaration(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof amnv_jrmListener ) ((amnv_jrmListener)listener).exitMethodDeclaration(this);
		}
	}
	...
	public final MethodDeclarationContext methodDeclaration() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__26) | (1L << T__23) | (1L << T__18) | (1L << T__10) | (1L << IDENTIFIER))) != 0)) {
				{
				{
	...
	public static class TypeContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof amnv_jrmListener ) ((amnv_jrmListener)listener).enterType(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof amnv_jrmListener ) ((amnv_jrmListener)listener).exitType(this);
		}
	}
	...
	public static class StatementContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof amnv_jrmListener ) ((amnv_jrmListener)listener).enterStatement(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof amnv_jrmListener ) ((amnv_jrmListener)listener).exitStatement(this);
		}
	}
	...
	public static class ExpressionContext extends ParserRuleContext {
		public TerminalNode INTEGER_LITERAL() { return getToken(amnv_jrmParser.INTEGER_LITERAL, 0); }
		public ExpressionContext expression(int i) {
			return getRuleContext(ExpressionContext.class,i);
		}
		public TerminalNode OP() { return getToken(amnv_jrmParser.OP, 0); }
		public TerminalNode IDENTIFIER() { return getToken(amnv_jrmParser.IDENTIFIER, 0); }
		public List<ExpressionContext> expression() {
			return getRuleContexts(ExpressionContext.class);
		}
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof amnv_jrmListener ) ((amnv_jrmListener)listener).enterExpression(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof amnv_jrmListener ) ((amnv_jrmListener)listener).exitExpression(this);
		}
	}
	...
	private ExpressionContext expression(int _p) throws RecognitionException {
		...
		try {
			...
			case 2:
				{
				setState(158); match(INTEGER_LITERAL);
				}
				break;
			case 3:
				{
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 4:
						...
						setState(202);
						_la = _input.LA(1);
						if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T